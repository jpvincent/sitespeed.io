...
module.exports = {
  ...
  processMessage(message, queue) {
    ...
    */if(message.type === 'webpagetest.pageSummary') {
      ...
      console.log('WEBPAGETEST GET CPU URL', message.data.data.median.firstView.rawData.trace)

      return getUrlAndUnzip(message.data.data.median.firstView.rawData.trace)
